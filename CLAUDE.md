...
This project has a knowledge graph at `graphify-out/` with god nodes, community structure, and cross-file relationships (1,974 nodes · 2,663 edges · 154 communities, built from 245 files).
