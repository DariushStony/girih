...
This project has a knowledge graph at `graphify-out/` with god nodes, community structure, and cross-file relationships (1,976 nodes · 2,678 edges · 145 communities, built from 245 files).
