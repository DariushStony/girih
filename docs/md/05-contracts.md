...
**components/button.contract.ts  [You write this]**
...
**extensions/payment-button.ext.ts  [You write this]**
...
```tsx
/* Generated by girih — do not edit. Source of truth: extensions/payment-button.ext.ts */
import { forwardRef } from 'react';
import { cx } from '@faravahar/girih-react-runtime';
